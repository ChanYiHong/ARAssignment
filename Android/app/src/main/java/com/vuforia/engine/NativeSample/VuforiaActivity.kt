...
class VuforiaActivity : AppCompatActivity(), GLSurfaceView.Renderer, SurfaceHolder.Callback {
    ...
    override fun onSurfaceChanged(unused: GL10, width: Int, height: Int) {
        ...
        var cupcakeTexture = Texture.loadTextureFromApk("cupcake.png", assets)
        var landerTexture = Texture.loadTextureFromApk("VikingLander.jpg", assets)
        if (cupcakeTexture != null && landerTexture != null) {
            setTextures(
                cupcakeTexture.width, cupcakeTexture.height, cupcakeTexture.data!!,
